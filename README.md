...
`Routing & Switching` • `P2P` • `ILL` • `Fiber` • `ONT` • `NOC Operations`
...
* 🚀 Optimized REST API performance by **25%**
* 🗄️ Improved ORM queries
...
| 👨‍💻 Tech Fest Leadership      |  **10-Member Team**  |
| 🎓 B.Tech CSE                   |     **7.5 CGPA**     |
| 📚 Diploma Computer Engineering |     **8.0 CGPA**     |
